...
const RackSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getByApplication.pending, handlePending)
            ...
            .addCase(getByApplication.rejected, handleRejected)
            .addCase(
            ...
            .addCase(getByApplication.fulfilled, (state: RackState, action: PayloadAction<Rack[]>) => {
                state.isLoading = false;
                state.error = null;
                state.rack = action.payload;
            })
